...
setwd("C:\\Users\\cajus\\OneDrive\\Dokumente\\Bildung\\Studium\\Job\\RNASeq\\Comparative analysis\\For chapter 4\\heat-exp\\results")
...
all_predicted_ML <- read.csv("C:\\Users\\cajus\\OneDrive\\Dokumente\\Bildung\\Studium\\Job\\RNASeq\\Comparative analysis\\For chapter 4\\heat-exp\\data\\genes_spring.csv")
...
for(name in names(my_list)){
  ...
  k <- 559 #number of predicted genes for spring
  #Create bar plot
