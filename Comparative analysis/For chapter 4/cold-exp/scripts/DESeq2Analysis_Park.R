#Differential Gene Expression Analysis of Park et al. 2018 with DESeq2
...
#Read and prepare file with sample information, quant.sf files and tx2gene file
            #######################
setwd("C:\\Users\\cajus\\OneDrive\\Dokumente\\Bildung\\Studium\\Job\\RNASeq\\EnezerML\\Cold_Stress\\Park\\DESeq2")

#Read Information about the samples (sample, repetition, group, accession)
#Group 0: warm, Group 1: 24hr-cold Group 2: 2-week-cold
#Repetition indicates the repetition of the experiment (the whole experiment was repeated 2 times)
...
write.csv(signif_all,file=paste("Genes_alpha=",alpha,"_l2fc=",l2fc,"/signif_all_park.csv",sep=""),row.names = FALSE)
